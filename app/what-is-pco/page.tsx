...
export default function WhatIsPCO() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-wa-green-50 relative">
      ...
      {/* Header */}
      <header className="bg-white/95 backdrop-blur-sm border-b border-wa-green-100 shadow-sm relative z-10" role="banner">
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <Link
              href="/"
              className="flex items-center text-wa-green-700 hover:text-wa-green-900 transition-colors duration-200 group focus:outline-none focus:ring-2 focus:ring-wa-green-500 focus:ring-offset-2 rounded-md px-2 py-1"
              aria-label="Go back to home page"
            >
              <ArrowLeft className="h-5 w-5 mr-2 group-hover:-translate-x-1 transition-transform" />
              <span className="font-medium">Back to Home</span>
            </Link>
            <h1 className="text-2xl font-bold text-wa-green-900">What is a PCO?</h1>
          </div>
        </div>
      </header>
      ...
      <main id="main-content" role="main" className="relative z-10">
        <div className="container mx-auto px-4 py-16 max-w-6xl">
          ...
          <section className="text-center mb-20 relative" aria-labelledby="pco-title">
            <div className="max-w-4xl mx-auto bg-white/80 backdrop-blur-sm rounded-2xl p-8 lg:p-12 shadow-lg">
              <h1
                id="pco-title"
          ...
          <section className="mb-20 bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-lg" aria-labelledby="responsibilities-heading">
            <div className="text-center mb-16">
              <h2 id="responsibilities-heading" className="text-3xl lg:text-4xl font-bold text-wa-green-900 mb-4">
            ...
            <div className="grid lg:grid-cols-3 gap-8" role="list">
              <Card
                className="bg-white/95 border-wa-green-100 shadow-lg hover:shadow-xl transition-all duration-300 group h-full focus-within:ring-2 focus-within:ring-wa-green-500"
                role="listitem"
              >
                <CardHeader className="text-center pb-4">
                  <Users
                    className="h-20 w-20 text-wa-green-600 mx-auto mb-6 group-hover:scale-110 group-hover:text-wa-green-700 transition-all duration-300"
                    aria-hidden="true"
                  />
                  <CardTitle className="text-2xl text-wa-green-900">Community Outreach</CardTitle>
                </CardHeader>
                <CardContent className="pt-0">
                  <ul className="text-wa-green-700 space-y-3 text-lg" role="list">
                    <li className="flex items-start" role="listitem">
                      <span className="text-wa-gold-500 mr-3 mt-1" aria-hidden="true">
                        •
                      </span>
              ...
              >
                <CardHeader className="text-center pb-4">
                  <Vote
                    ...
                    aria-hidden="true"
                  />
                  <CardTitle className="text-2xl text-wa-green-900">Party Leadership</CardTitle>
                </CardHeader>
                <CardContent className="pt-0">
                  <ul className="text-wa-green-700 space-y-3 text-lg" role="list">
                    <li className="flex items-start" role="listitem">
              ...
              >
                <CardHeader className="text-center pb-4">
                  <Megaphone
                    ...
                    aria-hidden="true"
                  />
                  <CardTitle className="text-2xl text-wa-green-900">Advocacy & Action</CardTitle>
                </CardHeader>
                <CardContent className="pt-0">
                  <ul className="text-wa-green-700 space-y-3 text-lg" role="list">
                    <li className="flex items-start" role="listitem">
          ...
          <section className="mb-20" aria-labelledby="statistics-heading">
            <Card className="bg-white/95 border-wa-green-200 shadow-xl backdrop-blur-sm">
              <CardHeader className="text-center pb-8">
                <CardTitle id="statistics-heading" className="text-3xl lg:text-4xl text-wa-green-900 mb-6">
                  Washington State's 7,500 Precincts
                </CardTitle>
                <p className="text-wa-green-700 text-xl max-w-3xl mx-auto">
              ...
              <CardContent className="p-8 lg:p-12">
                <div className="bg-gradient-to-br from-wa-green-50 to-wa-green-100 rounded-2xl p-8 lg:p-12 text-center">
                  <MapPin className="h-24 w-24 text-wa-green-600 mx-auto mb-8" />
                  <div className="grid md:grid-cols-3 gap-8 text-center mb-8" role="list">
                    <div className="bg-white rounded-xl p-6 shadow-md" role="listitem">
                      <div
                        className="text-4xl lg:text-5xl font-bold text-wa-green-700 mb-2"
                        aria-label="Seven thousand five hundred"
                      >
                        7,500
                      </div>
                      <div className="text-wa-green-600 font-medium text-lg">Precincts Statewide</div>
                    </div>
                    <div className="bg-white rounded-xl p-6 shadow-md" role="listitem">
                      <div className="text-4xl lg:text-5xl font-bold text-wa-green-700 mb-2" aria-label="Thirty nine">
                        39
                      </div>
                      <div className="text-wa-green-600 font-medium text-lg">Counties</div>
                    </div>
                    <div className="bg-white rounded-xl p-6 shadow-md" role="listitem">
                      <div
                        className="text-4xl lg:text-5xl font-bold text-wa-gold-600 mb-2"
                        aria-label="Approximately forty percent"
                      >
                        ~40%
                      </div>
                      <div className="text-wa-green-600 font-medium text-lg">PCO Positions Vacant</div>
                    </div>
                  </div>
                  <p className="text-wa-green-700 text-lg max-w-3xl mx-auto leading-relaxed">
          ...
          <section className="text-center">
            <Card className="bg-gradient-to-r from-wa-gold-50 to-wa-green-50 border-wa-gold-200 shadow-xl max-w-4xl mx-auto backdrop-blur-sm">
              <CardContent className="p-8 lg:p-12">
                <h3 className="text-3xl lg:text-4xl font-bold text-wa-green-900 mb-6">Ready to Make a Difference?</h3>
